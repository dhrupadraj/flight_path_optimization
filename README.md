...
click here --> [streamlit app link](https://dhrupadraj-flight-path-optimization-app-3vctir.streamlit.app/)
click here for seperate backend repo --> https://github.com/dhrupadraj/flight_backend.git
---
